//TODO: Make this file a class rather than a collection of globals for neatness(tm)
...
export const disconnectHandler = (e) => console.log(`client disconnected ${e}`);

export var messageCreate = async (msg): Promise<any> => {
